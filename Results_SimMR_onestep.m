...
dir_case = 'ResultsMC\Results_SimMR_onestep';

%% Set Parameters

% A1 = [0.6964    0.0886    0.0060
%        -0.1360    1.1426   -0.0268
%         0.9441   -0.2646    1.2505
%         ]';
% A2 = [0.2014   -0.0302   -0.0124
%         0.0140   -0.1210    0.0526
%        -0.5731    0.3116   -0.2179
%         ]' ;
% A3 = [-0.0665   -0.0098   -0.0535
%         0.2171    0.0543   -0.0469
%        -0.2626   -0.2679   -0.0346
%     ]' ;
% A4 = [   -0.0352   -0.1388    0.0297
%        -0.1452   -0.1793    0.0168
%         0.1000    0.2856   -0.0151
%     ]' ;
%
% B_true=[0.0121    0.0011    0.0227
%         0.0014    0.0235         0
%        -0.0042    0.0019    0.0073 ];
%
% Pi_true = [A1 A2 A3 A4];
