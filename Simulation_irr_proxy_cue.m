...
dir_case = 'ResultsMC\Results_irr_proxy_cue';
                ...
                for i_p = 1:length(p_vec)
                    ...
                    parfor i_rep = 1:nrep
                        ...
                        elseif strcmp(test_type, 'two_step')
                            thetastart = theta_z;
                            % [J_statistic,p_value,theta_est] = EstAndJTest_03_testsascha(U_hat,z_used,thetastart);
                            % [J_statistic,p_value,theta_est] = EstAndJTest_03(U_hat,z_used,thetastart );
                            [J_statistic,p_value,theta_est] = EstAndJTest_03CUE(U_hat,z_used,thetastart,conservative);
                        end
