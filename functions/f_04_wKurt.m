function [out] = f_04_wKurt(theta,U_hat,z_used)
[n,T] = size(U_hat);
...
out = [(U_hat(2:end,:)-theta*U_hat(1,:)).*z_used;...
    ...
    %   (U_hat(2:end,:)-theta*U_hat(1,:)).*real(z_used.^(1/2));...
    %   (U_hat(2:end,:)-theta*U_hat(1,:)).*real(z_used.^(3/2));...
    %   (U_hat(2:end,:)-theta*U_hat(1,:)).*real(z_used.^(5/2));...
        (U_hat(2:end,:)-theta*U_hat(1,:)).* z_used.^3  ];
